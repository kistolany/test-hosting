...
// Ensure SearchToolbar is imported
...
const Cover = () => {
  ...
  // Updated Config to match your MOCK_STUDENTS fields
  const coverSearchConfig = [
    { name: "batch", label: "Batch", placeholder: "Select Batch",width: "190px"},
    { name: "studyYear", label: "Study Year", placeholder: "Select Study Year", dataKey: "year_study" },
    { name: "major", label: "Major", placeholder: "Select Major" },
    { name: "faculty", label: "Faculty", placeholder: "Select Faculty" },
    { name: "Name", label: "Name", placeholder: "Select Name", dataKey: "name_en" },
  ];
