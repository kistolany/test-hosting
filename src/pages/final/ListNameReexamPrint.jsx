        ...
        <div className="paper-sheet">
          ...
          <div className="document-title-block" style={{ textAlign: 'center', marginTop: '30px' }}>
            <div className="khmer-moul" style={{ fontSize: 14 }}>
              {/* Wrapped ប្រឡងសង in a red span */}
              បញ្ជីរាយនាមនិស្សិត<span style={{ color: 'red' }}>ប្រឡងសង</span> ឆ្នាំទី{headerData.year} ឆមាសទី{headerData.semester} ជំនាន់ទី{headerData.generation} សិក្សាវគ្គ{headerData.shift}
            </div>
          ...
          <div style={{ marginTop: 20, fontSize: 15, fontWeight: 'bold' }}>
            {/* Wrapped ប្រឡងសង in a red span */}
            <div>សម្គាល់៖ បញ្ជីនិស្សិត<span style={{ color: 'red' }}>ប្រឡងសង</span>បញ្ចប់ត្រឹមចំនួន {totalCount} នាក់ ក្នុងនោះស្រីមានចំនួន {femaleCount} នាក់។</div>
          </div>
