...
const ScholarshipForm = () => {
      ...
      <Form className="scholarship-form" form={form} initialValues={{ study_year: "", batch: "" }}>
        {receiptTypes.map((type, index) => (
          <React.Fragment key={type.key}>
            <div className="receipt-content" style={{ pageBreakAfter: 'always' }}>
              ...
              <div className="receipt-body">
                ...
                <div className="form-line">
                  ...
                  <Form.Item name="city" noStyle><Input variant="borderless" className="dotted-input input w-14" />                <span className="sign-end">។</span>
</Form.Item>
                </div>
 ...
 {/* Right Side: Student */}
                  ...
                  <div className="sig-block">
                    ...
                    <div className="sig-space"></div>
                    <div className="sig-name-display" style={{height: 20}}></div>
                  </div>
